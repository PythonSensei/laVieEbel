...
game = hlt.Game("Liodeus")
# Then we print our start message to the logs
logging.info("Starting my Liodeus bot!")
    ...
    for ship in game_map.get_me().all_ships():
        ...
        for planet in game_map.all_planets():
            ...
            if ship.can_dock(planet):
                ...
                nearest_planet = None
                for nb, distance in enumerate(sorted(entities_by_distance)):
                    logging.debug("distance %s, %s" % (distance, nb))
                    ...
                    # logging.debug("nearest_planet %s" % nearest_planet)
                    #     if nearest_planet:
