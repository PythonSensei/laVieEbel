    ...
    for ship in game_map.get_me().all_ships():
        ...
        #1.2. Pour chaque planète (de la plus proche à la plus lointaine)#
            ...
            for planet in game_map.all_planets():
                ...
                dictVal[planet] = ship.calculate_distance_between(planet)
        ...
        #1.2.2.1. Aller à coté des vaisseaux dockés (sans suicide)#
                    ...
                    navigate_command = ship.navigate(ship.closest_point_to(listShip[0]),game_map,speed=int(hlt.constants.MAX_SPEED),ignore_planets=False)
